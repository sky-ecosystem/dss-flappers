...
contract FlapperUniV2SwapOnlyTest is DssTest {
    ...
    function setUp() public {
        ...
        (flapper, medianizer) = setUpFlapper(NGT, UNIV2_NST_NGT_PAIR, 727 * WAD) ;
    ...
    function testDefaultValues() public {
        FlapperUniV2SwapOnly f = new FlapperUniV2SwapOnly(NST_JOIN, SPOT, NGT, UNIV2_NST_NGT_PAIR, PAUSE_PROXY);
        assertEq(f.want(), WAD);
    ...
    function testIllegalGemDecimals() public {
        ...
        flapper = new FlapperUniV2SwapOnly(NST_JOIN, SPOT, USDC, UNIV2_NST_NGT_PAIR, PAUSE_PROXY);
    }
